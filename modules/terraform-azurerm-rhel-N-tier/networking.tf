...
//// RDP traffic
//
resource "azurerm_network_security_rule" "public-rule-rdp" {
  resource_group_name         = azurerm_resource_group.main.name
...
//
resource "azurerm_network_security_rule" "public-rule-ssh" {
  resource_group_name         = azurerm_resource_group.main.name
  network_security_group_name = azurerm_network_security_group.public.name
  name                        = "ansr-ssh"
...
//
resource "azurerm_network_security_rule" "public-rule-cifs" {
  resource_group_name         = azurerm_resource_group.main.name
  network_security_group_name = azurerm_network_security_group.public.name
  name                        = "ansr-cifs"
...
//
resource "azurerm_network_security_rule" "public-rule-http-application" {
  resource_group_name         = azurerm_resource_group.main.name
  network_security_group_name = azurerm_network_security_group.public.name
  name                        = "ansr-http"
...
//// HTTPS traffic
//
resource "azurerm_network_security_rule" "public-rule-https-application" {
  resource_group_name         = azurerm_resource_group.main.name
  network_security_group_name = azurerm_network_security_group.public.name
  name                        = "ansr-https"
...
//// RDP traffic
//
resource "azurerm_network_security_rule" "private-rule-rdp" {
  resource_group_name         = azurerm_resource_group.main.name
...
//// Allows SSH from allowed IPs - consider switching to a non-standard port or disabling for immutable infrastructure
//
resource "azurerm_network_security_rule" "private-rule-ssh" {
  resource_group_name         = azurerm_resource_group.main.name
  network_security_group_name = azurerm_network_security_group.private.name
  name                        = "ansr-ssh"
  description                 = "SSH open for debugging"
...
//
resource "azurerm_network_security_rule" "private-rule-postgres" {
  resource_group_name         = azurerm_resource_group.main.name
  network_security_group_name = azurerm_network_security_group.public.name
  name                        = "ansr-postgres"
